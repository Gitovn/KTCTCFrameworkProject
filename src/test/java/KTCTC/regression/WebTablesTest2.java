...
public class WebTablesTest2 extends TestBase {
	...
	public void verifyUserCanNavigateToWebTablesPage() {
		...
		objPage.setlName(cmObj.getcharacterString(7));
		objPage.setEmail(cmObj.getcharacterString(4) + "@" + cmObj.getcharacterString(5) + ".com");
		objPage.setAge(cmObj.getNumericString(2));
		objPage.setSalary(cmObj.getNumericString(8));
		objPage.setDepartment(cmObj.getcharacterString(5));

		objPageNew.setfName(cmObj.getcharacterString(5));
		objPageNew.setlName(cmObj.getcharacterString(7));
		objPageNew.setEmail(cmObj.getcharacterString(4) + "@" + cmObj.getcharacterString(5) + ".com");
		objPageNew.setAge(cmObj.getNumericString(2));
		objPageNew.setSalary(cmObj.getNumericString(8));
		objPageNew.setDepartment(cmObj.getcharacterString(5));
	...
	public void verifyExistingUserCanBeEdited() {
		webTablesPage.editExistingUserWithProvidedDetails(objPage, objPageNew);
	...
	public void verifyExistingUserCanBeDeleted() {
		webTablesPage.deleteExistingUserWithProvidedDetails(objPageNew);
		boolean flag = webTablesPage.isUserWithProvidedEmailIdDisplayed(objPageNew.getEmail());
