...
public class ChromeBrowser {
	...
	private WebDriver getChromeDriver(ChromeOptions cap) {
		...
		if (System.getProperty("os.name").contains("Mac")){
			System.setProperty("webdriver.chrome.driver", ResourceHelper.getResourcePath("src/main/resources/drivers/chromedrivers/chromedriver"));
			...
			System.setProperty("webdriver.chrome.driver", "/usr/bin/chrome/chromedrivers/chromedriver");
			return new ChromeDriver(cap);
		}
		return null;
	}
